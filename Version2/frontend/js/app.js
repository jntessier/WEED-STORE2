...
{       
  if (LOG_ENABLED) console.log("[Execute_Tests()] STARTED...");
  //Test('fs');
...
{   
    if (LOG_ENABLED) console.log("[fetch_Products()] STARTED...");
    ...
    if (reponse.length > 0 ) 
    {
       console.log("[fetch_Products()] products.json received");  console.log(reponse); 
